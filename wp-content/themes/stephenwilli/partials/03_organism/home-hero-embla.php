...
<section class="home-hero">
  ...
  <div class="embla">
    <div class="embla__viewport">
      <div class="embla__container js-embla-open">
        <?php if(have_rows('home_hero_slide')){ $i = 1; while(have_rows('home_hero_slide')){ the_row();
            $bgImage = get_sub_field('slide_image_bg');
            $overlay = get_sub_field('slide_image_overlay');
          ?>
          <div class="embla__slide">
            <div class="embla__slide__inner">
              <div class="cursor-compass image-warp">
